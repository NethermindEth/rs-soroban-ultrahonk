...
use ultrahonk_soroban_verifier::{PROOF_BYTES, ZK_PROOF_BYTES};
...
#[test]
fn verify_simple_circuit_zk_proof_succeeds() {
    let vk_bytes_raw: &[u8] = include_bytes!("../../../circuits/simple_circuit/target/zk/vk");
    let proof_bin: &[u8] = include_bytes!("../../../circuits/simple_circuit/target/zk/proof");
    let pub_inputs_bin: &[u8] =
        include_bytes!("../../../circuits/simple_circuit/target/zk/public_inputs");
